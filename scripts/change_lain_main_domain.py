...
def upgrade_sso_groups(access_token, former_domain):
    appnames = get_console_apps(access_token)
    for appname in appnames:
        former_group_name = get_former_groupname(appname, former_domain)
...
def main():
    ...
    add_former_domain_option(parser)
    ...
    if login_success:
        upgrade_sso_groups(token, options.former_domain)
