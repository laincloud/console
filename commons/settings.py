...
DOMAIN = get_etcd_value("/lain/config/domain", ETCD_AUTHORITY, default='example.lain.com')
...
# calico setting
CALICO_NETWORK = get_etcd_value("/lain/config/calico_network", ETCD_AUTHORITY, default=None)
...
REGISTRY_IP_WHITELIST = get_etcd_value("/lain/config/registry_ip_whitelist", ETCD_AUTHORITY, default='')
NODE_NETWORK = get_etcd_value("/lain/config/node_network", ETCD_AUTHORITY, default=None)
